...
class CreateRootBoard extends Component {
  constructor(props) {
    super(props);
    this.state = {
      boardName: '',
...
imageUrl: this.state.imageUrl, category_id: null, active: true, description: this.state.description
, secretKey: this.state.secretKey}, {headers: {
...
export default CreateRootBoard;
